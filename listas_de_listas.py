...
def encontra_duplicado(param_lista_inteiros):
    num_check = set()
...
#     print(lista_inteiros, encontra_duplicado(lista_inteiros))

# print(encontra_duplicado([1,2,3,3,2,1])) #testei pra ver se tava certo
# print(encontra_duplicado([1,2,3,4,5,6]))